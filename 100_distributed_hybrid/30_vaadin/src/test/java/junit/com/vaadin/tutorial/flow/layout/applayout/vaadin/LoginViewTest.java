...
public class LoginViewTest
  ...
  public static class LoginViewPageObject
    ...
    public TextFieldElement username() {
      return $(TextFieldElement.class).id(LoginView.USERNAME);
    }

    public PasswordFieldElement password() {
      return $(PasswordFieldElement.class).id(LoginView.PASSWORD);
    }

    public ButtonElement btn() {
      return $(ButtonElement.class).id(LoginView.BTN_LOGIN);
    }
